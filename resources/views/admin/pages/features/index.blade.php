...
@section('content')
    <section class="main_content dashboard_part large_header_bg">
        ...
        @include('admin/partials/_head_pages', ['pageTitle' => 'Add Feature'])
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="white_card_body">
                        <div class="QA_section">
                            <div class="white_box_tittle list_header">
                                <a class="btn_1" href="{{route('admin.features.create')}}">Add Feature</a>
                            ...
                            <div class="QA_table mb_30">
                                ...
                                <table class="table lms_table_active hel-table ">
                                    ...
                                    @foreach($data as $feature)
                                        <tr>
                                            <th scope="row"><a href="#" class="question_content"> {{$feature->id}} </a>
                                            </th>
                                            <td><a href="">{{$feature->title}}</a></td>
                                            <td><a href="">{{$feature->description}}</a></td>
                                            <td>
                                                <img src="{{asset($feature->image)  }}" style="width: 20%" alt="">
                                            </td>
