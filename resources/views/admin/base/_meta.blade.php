<head>
    ...
    <title>Matrix Management Admin</title>
    ...
    <link rel="stylesheet" href="{{asset('css/add_career.css')}}" />
    <link rel="stylesheet" href="{{asset('css/colors/default.css')}}" id="colorSkinCSS">
    <link rel="stylesheet" href="{{asset('css/upload_file.css')}}" id="colorSkinCSS">
